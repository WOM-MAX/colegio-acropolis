...
export default async function JournalCategoriasPage() {
  const categorias = await db.query.journalCategorias.findMany({
    orderBy: [desc(journalCategorias.orden)],
  });
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-negro sm:text-3xl">
            Categorías del Journal
          </h1>
          <p className="mt-1 text-sm text-gris-texto">
            Gestiona las secciones temáticas de las noticias.
          </p>
        </div>
        <Link
          href="/admin/journal/categorias/nuevo"
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        <Link
                          href={`/admin/journal/categorias/${cat.id}/editar`}
                        ...
                        <DeleteFormButton 
                          ...
                          confirmMessage="¿Estás seguro de eliminar esta categoría? Las noticias asociadas quedarán sin categoría, pero no se borrarán." 
                        />
                      </div>
                    </td>
                  </tr>
